...
def get_mock_cdk_scope(
    *,
    ...
    mgmt_acct_id: Optional[str] = None,
    dev_acct_id: Optional[str] = None,
    ci_acct_id: Optional[str] = None,
    prod_acct_id: Optional[str] = None,
    ...
    context_vars_dict = {
        ...
        # SharedPipelineConfig params
        "MgmtAccountId": mgmt_acct_id,
        "DevAccountId": dev_acct_id,
        "CiAccountId": ci_acct_id,
        "ProdAccountId": prod_acct_id,
...
class PipIndexConfigTest(TestCase):
    ...
    def test_update_secret(self):
        ...
        secrets_mgr: SecretsManagerClient = boto3.client("secretsmanager", region_name="eu-west-2")
        secrets_mgr.create_secret(Name=test_username, SecretString=test_password)
        ...
        expected_pipeline_config = PipelineConfig(
            ...
            common=CommonPipelineConfig(
                ...
                account_ids=AccountIdConfig(
                    self.test_ssm_config,
                    mgmt_acct_id=expected_mgmt_account_id,
                    dev_acct_id=expected_dev_account_id,
                    ci_acct_id=expected_ci_account_id,
                    prod_acct_id=expected_prod_account_id,
                ),
